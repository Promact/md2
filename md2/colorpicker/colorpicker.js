...
(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", '@angular/core', '@angular/forms', '@angular/common', './colorpicker.service'], factory);
    }
    ...
    var colorpicker_service_1 = require('./colorpicker.service');
    var noop = function () { };
    var nextId = 0;
    exports.MD2_COLORPICKER_CONTROL_VALUE_ACCESSOR = {
        provide: forms_1.NG_VALUE_ACCESSOR,
        useExisting: core_1.forwardRef(function () { return Md2Colorpicker; }),
        multi: true
    };
    ...
    var Md2Colorpicker = (function () {
        ...
        Md2Colorpicker.prototype.ngOnInit = function () {
            var hsva = this.service.stringToHsva(this.innerValue);
            if (hsva !== null) {
                this.hsva = hsva;
            }
            else {
        ...
        */
        ...
        Md2Colorpicker.prototype.registerOnChange = function (fn) { this.onChangeCallback = fn; };
        Md2Colorpicker.prototype.registerOnTouched = function (fn) { this.onTouchedCallback = fn; };
        __decorate([
            core_1.Input('format'), 
            __metadata('design:type', String)
        ...
        Md2Colorpicker = __decorate([
            ...
            __metadata('design:paramtypes', [colorpicker_service_1.ColorpickerService, core_1.ElementRef])
        ], Md2Colorpicker);
    ...
    exports.MD2_COLORPICKER_DIRECTIVES = [Md2Colorpicker, ColorpickerSliderDirective, TextDirective];
    var Md2ColorpickerModule = (function () {
        ...
        Md2ColorpickerModule = __decorate([
            core_1.NgModule({
                declarations: exports.MD2_COLORPICKER_DIRECTIVES,
                imports: [common_1.CommonModule, forms_1.FormsModule],
                exports: exports.MD2_COLORPICKER_DIRECTIVES,

...
(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", '@angular/core', './colorpicker'], factory);
    }
            ...
            if (hsva.a < 1) {
                switch (outputFormat) {
                    case 'hsla':
                        ...
                        var hslaText = new colorpicker_1.Hsla(Math.round((hsla.h) * 360), Math.round(hsla.s * 100), Math.round(hsla.l * 100), Math.round(hsla.a * 100) / 100);

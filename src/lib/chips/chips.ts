...
`,
  styles: [`
    ...
    :host{outline:none;}
    :host .md2-chips-container{display: block;box-shadow: 0 1px #ccc;padding: 5px 0;margin-bottom:10px;min-height:50px;box-sizing: border-box;clear:both;}
    :host .md2-chips-container:after{clear:both;content:'';display:table;}
    :host.chip-input-focus .md2-chips-container{box-shadow: 0 2px #0d8bff;}
    :host .md2-chip-disabled{cursor: default;}
    :host md2-autocomplete{margin:7px 0;}

 ...
 * found in the LICENSE file at https://angular.io/license
 */
var VERSION=new _angular_core.Version("4.0.0"),NgNoValidate=function(){function NgNoValidate(){}return NgNoValidate}();NgNoValidate.decorators=[{type:_angular_core.Directive,args:[{selector:"form:not([ngNoForm]):not([ngNativeValidate])",host:{novalidate:""}}]}],NgNoValidate.ctorParameters=function(){return[]};/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be

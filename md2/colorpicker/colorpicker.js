...
import { Component, Input, Output, EventEmitter, forwardRef, ViewEncapsulation, NgModule, ElementRef, Directive } from '@angular/core';
import { NG_VALUE_ACCESSOR, FormsModule } from '@angular/forms';
import { CommonModule } from '@angular/common';
import { ColorpickerService } from './calculateColor';
var noop = function () { };
var nextId = 0;
export var MD2_COLORPICKER_CONTROL_VALUE_ACCESSOR = {
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(function () { return Md2Colorpicker; }),
    multi: true
};
...
export var Md2Colorpicker = (function () {
    ...
    */
    ...
    Md2Colorpicker = __decorate([
        ...
        __metadata('design:paramtypes', [ColorpickerService, ElementRef])
    ], Md2Colorpicker);

...
import { ContentChild, Directive, ElementRef, Host, HostListener, NgModule } from '@angular/core';
import { CommonModule } from '@angular/common';
export var Md2MenuNotClosable = (function () {
...
export var Md2Menu = (function () {
    ...
    __decorate([
        ContentChild(Md2MenuNotClosable), 
...
export var Md2MenuOpen = (function () {
    ...
    Md2MenuOpen = __decorate([
        ...
        __param(0, Host()), 
        __metadata('design:paramtypes', [Md2Menu, ElementRef])
    ], Md2MenuOpen);
    return Md2MenuOpen;
}());
export var MD2_MENU_DIRECTIVES = [Md2MenuNotClosable, Md2Menu, Md2MenuOpen];
